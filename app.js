...
let finState = {eventoId:null,moneda:'USD',gastos:[],gastosAll:null,totales:[],deudas:[],balance:[],editingGasto:null,selCats:['alojamiento'],selSplit:[],selMon:'USD',rsvpConfirmadas:[]};
const TIPOS = {
